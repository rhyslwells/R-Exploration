# Statistical Tests Overview - Squid Data Analysis

## Purpose
This document explains what each statistical test in `0-example1.R` is looking for and what the results tell us about the squid dataset.
